...
// */
//
//public class CustomShiroAuthenticationHandler extends AbstractUsernamePasswordAuthenticationHandler {
//
//    private static final Logger logger = LoggerFactory.getLogger(CustomShiroAuthenticationHandler.class);
//
//    @Autowired
...
//
//    public CustomShiroAuthenticationHandler(String name,ServicesManager servicesManager,PrincipalFactory principalFactory,Integer order) {
